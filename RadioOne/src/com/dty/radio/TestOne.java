...
import java.lang.*;   
public class TestOne extends JFrame implements MouseListener{  
    ...
    {  
        ...
        //设置窗口上的图标  
        Image img = this.getToolkit().getImage(getClass().getResource("D://1.jpg"));  
...
//                      }     
    ...
    {  
        ...
        {  
            ...
            if( audioDataBuffer != null)  //audioDataBuffer定义每次录音的时候每次提取字节来画音频波  
            {   
                ...
                {  
                   ...
                   // System.out.println((int)audioDataBuffer[i]);
                }  
            }  
        }  
        public void run()   
